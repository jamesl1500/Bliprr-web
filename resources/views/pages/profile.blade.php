    ...
    <div class="page-profile-bottom">
        <div class="page-profile-bottom-inner container-lg">
            <div class="page-profile-bottom-row row">
                <div class="page-profile-bottom-left col-lg-3">
                ...
                <div class="page-profile-bottom-middle col-lg-6">
                ...
                <div class="page-profile-bottom-right col-lg-3">
                    <div class="page-profile-bottom-right-actions">
                        <?php
                    ...
                    <div class="page-profile-bottom-right-trending">
